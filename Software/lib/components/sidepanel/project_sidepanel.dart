...
class ProjectSidePanel extends StatefulWidget {
  final Map<String, dynamic> data;
  final String id;
  const ProjectSidePanel({super.key, required this.data, required this.id});

  @override
  State<ProjectSidePanel> createState() => _ProjectSidePanelState();
}

class _ProjectSidePanelState extends State<ProjectSidePanel> {
