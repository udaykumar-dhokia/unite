...
class DesktopCompanyLogin extends StatefulWidget {
  const DesktopCompanyLogin({super.key});

  @override
  State<DesktopCompanyLogin> createState() => _DesktopCompanyLoginState();
}

class _DesktopCompanyLoginState extends State<DesktopCompanyLogin> {
