...
import 'package:unite/auth/login/desktop_company_login.dart';
...
class DesktopCompanySignup extends StatefulWidget {
  const DesktopCompanySignup({super.key});

  @override
  State<DesktopCompanySignup> createState() => _DesktopCompanySignupState();
}

class _DesktopCompanySignupState extends State<DesktopCompanySignup> {
  ...
  void signup(String email, String password, final data) async {
    try {
      ...
      String fileName =
          'profile_images/${data["email"]}/${DateTime.now().millisecondsSinceEpoch}_profile.png';
      String bannerName =
          'profile_images/${data["email"]}/${DateTime.now().millisecondsSinceEpoch}_banner.png';
      ...
      await FirebaseFirestore.instance
          .collection("company")
          .doc(data["email"])
          .update({"profileImage": downloadUrl, "bannerImage": downloadUrl1});
      await FirebaseFirestore.instance
          .collection("company")
          .doc(data["email"])
          .collection("Theme")
          .doc("settings")
          .set({"mode": false, "color": "0xFFFFC107"});
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Select options that best describes the company",
                                  style: GoogleFonts.epilogue(
                                      color: isDark
                                          ? AppColors.white
                                          : AppColors.black),
                                  ...
                                  onTap: () {
                                    if (_name.text.isEmpty ||
                                      ...
                                      final data = {
                                        ...
                                        "established": _dob.text,
                                        "username": _username.text,
                                        "companyTags": tags,
                                        "contact": double.parse(_mobile.text),
                                      };
